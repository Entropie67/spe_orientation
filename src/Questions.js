// L'objet avec les différentes spécialités et les scores associés
let specialites = {
    "NSI": 0,
    "Maths": 0,
    "PC": 0,
...
// La fonction qui va évaluer les résultats
function evaluerResultats() {
    // Initialisation des score au début de l'évaluation pour être sûr que tout est à 0
    ...
    /******************************* */
    // Question 01
    let scoreProbleme = document.getElementById('probleme_resoudre'.value, 0);
    ...
    // Question 04
    let scoreCoeur = document.getElementById('app_coeur'.value, 0);
